...
namespace license_manager.UI
{
    public partial class add_product : MaterialForm
    {
        ...
        private void materialRaisedButton1_Click(object sender, EventArgs e) // add
        {
            ...
            {
                Program.product_info.name_product = this.materialSingleLineTextField1.Text;
                ...
                Program.log_info.log_add_add_product(materialSingleLineTextField1.Text, DateTime.Now);
        ...
        private void materialRaisedButton2_Click(object sender, EventArgs e)  // save edit
        {
            for (int i = listView1.Items.Count - 1; i >= 0; i--)
            {
                if (listView1.Items[i].Selected)
                {
                    ...
                    Program.log_info.log_add_edit_product(this.listView1.FocusedItem.SubItems[0].Text, DateTime.Now);
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            for (int i = listView1.Items.Count - 1; i >= 0; i--)
            {
                if (listView1.Items[i].Selected)
                {
                    Program.log_info.log_add_delete_product(this.listView1.FocusedItem.SubItems[0].Text.ToString(), DateTime.Now);
